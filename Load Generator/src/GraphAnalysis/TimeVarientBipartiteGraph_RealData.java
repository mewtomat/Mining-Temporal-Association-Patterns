...
public class TimeVarientBipartiteGraph_RealData {
	...
	public int[] ColorThresholds = {0, 20, 200, 2000, 20000, 200000};//new int [NoOfCOLORS]; 
	...
	public TimeVarientBipartiteGraph_RealData(String path, String fileName) {
	...
	public static void main(String[] args) {
		...
		TimeVarientBipartiteGraph_RealData tvbg = new TimeVarientBipartiteGraph_RealData("E:\\manoj\\3gBI\\Novartis\\data\\TimeVariantBG\\", "ds_sales_new_1.txt");
