(function (j$) {	
		j$(function () {
			...
			j$('BODY').addTag({tagNode :'.stats-ppct-notification', tagName : 'COLLABRATEC_LIBRARY',
				analyticType : 'unica',
				tagType:'dynamic'
			});
			j$('BODY').addTag({tagNode :'.stats-ppct-notification-myproject', tagName : 'COLLABRATEC_LIBRARY',
				analyticType : 'unica',
				tagType:'dynamic'
			});
			j$('.stats-ppct').addTag({tagNode :'.stats-ppct-notification', tagName : 'COLLABRATEC_LIBRARY',
				analyticType : 'unica',
				tagType:'dynamic'
			});
			/********** Footer Page Tagging *****************/
